...
const nameText = 'Michael Piccirilli';
const roles = [
    ...
    <section id="hero" className="hero-typing">
      <div className="hero-typing-container hero-animate">
        <div className="hero-typing-text">
          <p className="hero-typing-greeting">Ciao, mi chiamo</p>
          ...
          {nameFinished && (
            <div className="hero-university-badge">
              <img src="/imgs/univaq.gif" alt="UnivAQ" className="hero-university-logo" />
          ...
          <div className="hero-typing-socials">
            <a href="https://github.com/Mik1810" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
            ...
            <a href="https://www.linkedin.com/in/michael-piccirilli/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
        ...
        <div className="hero-typing-image photo-glow">
          <img className="float-animation" src="/imgs/michael.jpg" alt="Michael Piccirilli" />
        </div>
      </div>
    </section>
  );
