...
const handleTiltStart = (event: MouseEvent<HTMLDivElement>, reducedMotion: boolean) => {
...
const handleTilt = (event: MouseEvent<HTMLDivElement>, reducedMotion: boolean) => {
  if (reducedMotion) return
      ...
      {showProjectSkeletons
        ...
        : projects.map((project, index) => (
            <div
              ...
              onMouseEnter={(event) => handleTiltStart(event, reducedMotion)}
              onMouseMove={(event) => handleTilt(event, reducedMotion)}
